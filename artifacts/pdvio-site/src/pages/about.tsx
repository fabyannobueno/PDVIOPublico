        ...
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          <div className="relative border-l-2 border-primary/20 pl-8 ml-4 md:ml-0 md:pl-0 md:border-l-0">
            ...
            {[
              ...
              >
                <div className={`absolute top-0 w-12 h-12 bg-background border-4 border-primary rounded-full flex items-center justify-center z-10 -left-14 md:left-auto ${i % 2 === 0 ? 'md:-right-6' : 'md:-left-6'}`}>
